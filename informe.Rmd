...
```{r,echo=TRUE,eval=TRUE}
#ECHO MUESTRA LAS LINEAS DE CODIGO 
#EVAL CORRE LAS LINEAS DE CODIGO
...
### Pruebas de hipótesis para beta 2 utilizado la prueba T 

Como $T=`r summary(reg)[[4]][2,3]`$ es `r tex<-"menor"; if(summary(reg)[[4]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"mayor"; tex` que $T_{1,`r (nrow(data)-2)`}(\frac{\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
`r tex<-"no rechazo"; if(summary(reg)[[4]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"rechazo"; tex`
$H_0: \beta_2=0$.
